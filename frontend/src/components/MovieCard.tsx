  ...
  <div className="absolute -top-6 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2">
    {addedToHistory ? (
      <>
        <Button
          size="icon"
          className="bg-green-500 hover:bg-green-600 text-white rounded-full w-10 h-10 shadow-lg shadow-green-500/50"
          disabled
        >
          <Check className="w-6 h-6" />
        </Button>
        <span className="bg-green-500/90 text-white text-sm font-bold px-3 py-1 rounded-full border border-green-400 whitespace-nowrap">
          Added to History!
        </span>
      </>
    ) : (
      <>
        <Button
          size="icon"
          className="bg-blue-500 hover:bg-blue-600 text-white rounded-full w-10 h-10 shadow-lg shadow-blue-500/50"
          disabled
        >
          <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
        </Button>
        <span className="bg-blue-500/90 text-white text-sm font-bold px-3 py-1 rounded-full border border-blue-400 whitespace-nowrap">
          Adding...
        </span>
      </>
    )}
      ...
      <Card
        onClick={handleClick}
        className={`group relative p-0 bg-black border transition-all duration-500 hover:scale-105 cursor-pointer overflow-hidden rounded-md ${
          addedToHistory
          ...
          <div className="relative overflow-hidden rounded-md">
            <div className="w-full h-80 bg-gray-800 flex items-center justify-center">
              {imageLoading && !imageError && (
                <div className="absolute bg-gray-800 animate-pulse flex items-center justify-center">
            ...
            <div className="absolute bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
